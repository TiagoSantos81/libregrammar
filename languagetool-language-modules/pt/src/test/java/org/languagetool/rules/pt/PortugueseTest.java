...
public class PortugueseTest extends LanguageSpecificTest {
  ...
  public void testLanguage() throws IOException {
    ...
    String s = "Cole aqui seu texto...ou verifique esta texto, afim de revelar alguns dos dos problemas que o LanguageTool consegue detectar. Isto tal vez permita corrigir os seus erro. Nós prometo ajudá-lo. para testar a grafia e as regrs do antigo) Acordo Ortográfico,, verifique o mesmo texto mesmo texto em Português de Angola ou Português do Moçambique e faça a analise dos resultados.. Nossa equipe anuncias a próxima versão será lançada sexta-feira, 26 de março de 2020.";
    PortugalPortuguese lang = new PortugalPortuguese();
    testDemoText(lang, s,
      Arrays.asList("POSSESSIVE_WITHOUT_ARTICLE", "STYLE_REPEATED_WORD_RULE_PT", "SPACE_AFTER_PUNCTUATION", "GENERAL_GENDER_AGREEMENT_ERRORS", "AFIM_DE", "PORTUGUESE_WORD_REPEAT_RULE", "PT_POS_AGREEMENT_REPLACE", "TAL_VEZ", "GENERAL_NUMBER_AGREEMENT_ERRORS", "GENERAL_VERB_AGREEMENT_ERRORS", "UPPERCASE_SENTENCE_START", "HUNSPELL_RULE", "UNPAIRED_BRACKETS", "DOUBLE_PUNCTUATION", "PHRASE_REPETITION", "STYLE_REPEATED_WORD_RULE_PT", "STYLE_REPEATED_WORD_RULE_PT", "ARTICLES_PRECEDING_LOCATIONS", "PARONYM_ANALISE_363", "DOUBLE_PUNCTUATION", "POSSESSIVE_WITHOUT_ARTICLE", "EQUIPES", "T-V_DISTINCTION", "DATE_WEEKDAY")
    );
