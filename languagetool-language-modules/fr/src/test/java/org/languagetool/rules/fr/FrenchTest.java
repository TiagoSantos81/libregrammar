...
public class FrenchTest extends LanguageSpecificTest {
  ...
  public void testLanguage() throws IOException {
    ...
    testDemoText(lang, s,
      Arrays.asList("STYLE_REPEATED_WORD_RULE_FR", "STYLE_REPEATED_WORD_RULE_FR", "FR_SPELLING_RULE", "ACCORD_GENRE", "TRAIT_UNION_INVERSION", "FRENCH_WORD_REPEAT_RULE", "SUR_ACCENT", "HEURES", "DATE_JOUR")
    );
    runTests(lang);
  }
}
